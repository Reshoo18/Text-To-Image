    ...
    viewport={{once:true}}
     >
        ...
        <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            ...
            <input onChange={e=> setEmail(e.target.value)} value={email} type="text" className='outline-none text-sm' placeholder='Email Id' />
        </div>

        <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            <img src={assets.lock_icon} alt="" />
            <input onChange={e=> setPassword(e.target.value)} value={password} type="text" className='outline-none text-sm' placeholder='Password' />
        </div>
