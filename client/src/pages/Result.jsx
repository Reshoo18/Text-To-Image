...
//         <span className={`absolute bottom-0 left-0 h-1 bg-blue-500 ${loading?'w-full transistion-all duration-[10s]' : 'w-0'}`}/> 
//       </div>
...
const Result = () => {
  ...
  const { generateImage, image } = useContext(AppContext);
